...
class MenuScreen(Screen):
    ...
    def load_content(self):
        ...
        self.game_name = pygame.image.load(r'content\Game_name.png')
        self.game_name = pygame.transform.scale(self.game_name, (1000, 35))

        self.start = pygame.image.load(r'content\Start_button.png')
        self.start = pygame.transform.scale(self.start, (200, 30))

        self.quit = pygame.image.load(r'content\Quit_button.png')
        self.quit = pygame.transform.scale(self.quit, (200, 30))

        self.boat_1 = pygame.image.load(r'content\Boat1.png')
        self.boat_1 = pygame.transform.scale(self.boat_1, (1200, 700))

        self.boat_2 = pygame.image.load(r'content\Boat2.png')
        self.boat_2 = pygame.transform.scale(self.boat_2, (900, 700))

        self.chopper = pygame.image.load(r'content\chopper.png')
